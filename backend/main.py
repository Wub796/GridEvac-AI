"""
main.py — GridEvac AI FastAPI Backend (Houston, TX)
----------------------------------------------------
Endpoints
  GET  /health                  → health check
  GET  /api/city                → full city graph (nodes, edges, substations)
  GET  /api/flood-zones         → flooded node IDs for a given flood_level
  POST /api/calculate-route     → weighted Dijkstra + anomaly detection
"""
